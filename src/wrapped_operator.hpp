...
namespace processwarp {
  ...
  public:
     ...
     */
    WrappedOperator(VMemory::Accessor& memory_);
  ...
  public:
     ...
     * @param memory Memory accessor.
     */
    WrappedPrimitiveOperator(VMemory::Accessor& memory);
  ...
  public:
     ...
     * @param memory Memory accessor.
     */
    WrappedPointerOperator(VMemory::Accessor& memory);
  ...
  public:
     ...
     * @param memory Memory accessor.
     */
    WrappedComplexOperator(VMemory::Accessor& memory);
