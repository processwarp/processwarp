...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #3 {
  ...
  %2 = select i1 %1, void (...)* null, void (...)* bitcast (void ()* @second to void (...)*)
  store void (...)* %2, void (...)** @fp, align 8, !tbaa !1
  store volatile i32 0, i32* %x, align 4
  %3 = call i32 @setjmp(%struct.__jmp_buf* getelementptr inbounds ([1 x %struct.__jmp_buf]* @buf, i64 0, i64 0)) #7
  %4 = icmp eq i32 %3, 0
