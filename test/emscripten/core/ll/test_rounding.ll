...
define i32 @main() #0 {
  ...
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %1) #3
  %3 = tail call double @round(double 1.600000e+00) #4
  %4 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %3) #3
  %5 = tail call double @round(double -1.400000e+00) #4
  %6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %5) #3
  %7 = tail call double @round(double -1.600000e+00) #4
  %8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %7) #3
  %9 = tail call double @round(double 1.500000e+00) #4
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %9) #3
  ...
  %14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %13) #3
  %15 = tail call double @round(double -2.500000e+00) #4
  %16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %15) #3
  %17 = tail call i64 @lrint(double 1.400000e+00) #3
  %18 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %17) #3
  %19 = tail call i64 @lrint(double 1.600000e+00) #3
  %20 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %19) #3
  %21 = tail call i64 @lrint(double -1.400000e+00) #3
  %22 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %21) #3
  %23 = tail call i64 @lrint(double -1.600000e+00) #3
  %24 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %23) #3
  %25 = tail call i64 @lrint(double 1.500000e+00) #3
  %26 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %25) #3
  %27 = tail call i64 @lrint(double 2.500000e+00) #3
  %28 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %27) #3
  %29 = tail call i64 @lrint(double -1.500000e+00) #3
  %30 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %29) #3
  %31 = tail call i64 @lrint(double -2.500000e+00) #3
  %32 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i64 0, i64 0), i64 %31) #3
  ...
  %35 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0), double 0x400921FB53C8D4F1, double %34, double %33) #3
  %36 = call double @modf(double 0xC00921FB53C8D4F1, double* %intpart) #3
  %37 = load double* %intpart, align 8, !tbaa !1
  %38 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0), double 0xC00921FB53C8D4F1, double %37, double %36) #3
  ret i32 0
}
