...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0), double 0x400921FB54442D18, double 0xC00921FB54442D18, i32 1) #3
  %2 = call float @fabsf(float 0x7FF8000000000000) #3
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 0) #3
  %4 = call float @fabsf(float 0x7FF0000000000000) #3
  %5 = fcmp une float %4, 0x7FF0000000000000
  %6 = zext i1 %5 to i32
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %6) #3
  %8 = call float @fabsf(float 0xFFF0000000000000) #3
  %9 = fcmp une float %8, 0x7FF0000000000000
  %10 = zext i1 %9 to i32
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %10) #3
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 1) #3
  %13 = call float @fabsf(float 0x7FF8000000000000) #3
  %14 = fcmp oeq float %13, 0x7FF0000000000000
  %15 = zext i1 %14 to i32
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %15) #3
  %17 = call float @fabsf(float 0x7FF0000000000000) #3
  %18 = fcmp oeq float %17, 0x7FF0000000000000
  %19 = zext i1 %18 to i32
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %19) #3
  %21 = call float @fabsf(float 0xFFF0000000000000) #3
  %22 = fcmp oeq float %21, 0x7FF0000000000000
  %23 = zext i1 %22 to i32
  %24 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %23) #3
  %25 = call i32 @isinf(double 1.230000e+01) #4
  %26 = icmp ne i32 %25, 0
  %27 = zext i1 %26 to i32
  %28 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %27) #3
  %29 = call i64 @div(i32 23, i32 10) #4
  %30 = trunc i64 %29 to i32
  %31 = lshr i64 %29, 32
  %32 = trunc i64 %31 to i32
  %33 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %30) #3
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %32) #3
  %35 = call i64 @div(i32 -5, i32 3) #4
  %36 = trunc i64 %35 to i32
  %37 = lshr i64 %35, 32
  %38 = trunc i64 %37 to i32
  %39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %36) #3
  %40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %38) #3
  %41 = call i64 @div(i32 5, i32 -3) #4
  %42 = trunc i64 %41 to i32
  %43 = lshr i64 %41, 32
  %44 = trunc i64 %43 to i32
  %45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %42) #3
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %44) #3
  %47 = call i64 @div(i32 -5, i32 -3) #4
  %48 = trunc i64 %47 to i32
  %49 = lshr i64 %47, 32
  %50 = trunc i64 %49 to i32
  %51 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %48) #3
  %52 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %50) #3
  %53 = call double @modf(double 3.200000e+00, double* %y) #3
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %53) #3
  %55 = load double* %y, align 8, !tbaa !1
  %56 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %55) #3
  %57 = call double @modf(double -3.200000e+00, double* %y) #3
  %58 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %57) #3
  %59 = load double* %y, align 8, !tbaa !1
  %60 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %59) #3
  %61 = call float @modff(float 0x40099999A0000000, float* %y2) #3
  %62 = fpext float %61 to double
  %63 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %62) #3
  %64 = load float* %y2, align 4, !tbaa !5
  %65 = fpext float %64 to double
  %66 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %65) #3
  %67 = call float @modff(float 0xC0099999A0000000, float* %y2) #3
  %68 = fpext float %67 to double
  %69 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %68) #3
  %70 = load float* %y2, align 4, !tbaa !5
  %71 = fpext float %70 to double
  %72 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %71) #3
  ...
  %74 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %73) #3
  %75 = load double* %cosine, align 8, !tbaa !1
  %76 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), double %75) #3
  ...
  %79 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %78) #3
  %80 = load float* %fcosine, align 4, !tbaa !5
  %81 = fpext float %80 to double
  %82 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %81) #3
  ...
  %91 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %90) #3
  %92 = load float* %fcosine, align 4, !tbaa !5
  %93 = fpext float %92 to double
  %94 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), double %93) #3
