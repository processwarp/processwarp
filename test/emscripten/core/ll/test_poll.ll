...
define i32 @main() #0 {
  ...
  %2 = call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 511)
  %3 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 0, i32 0
  store i32 %2, i32* %3, align 16, !tbaa !1
  %4 = call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([8 x i8]* @.str1, i64 0, i64 0), i32 0, i32 511)
  ...
  %7 = call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 511)
  %8 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 3, i32 0
  store i32 %7, i32* %8, align 8, !tbaa !1
  %9 = call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 511)
  ...
  %17 = call i32 @poll(%struct.pollfd* %16, i64 5, i32 123)
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str2, i64 0, i64 0), i32 %17)
  %19 = call i32* @__errno_location() #5
  %20 = load i32* %19, align 4, !tbaa !8
  %21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str3, i64 0, i64 0), i32 %20)
  %22 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 0, i32 2
  %23 = load i16* %22, align 2, !tbaa !9
  %24 = icmp eq i16 %23, 5
  %25 = zext i1 %24 to i32
  %26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str4, i64 0, i64 0), i32 %25)
  %27 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 1, i32 2
  %28 = load i16* %27, align 2, !tbaa !9
  %29 = icmp eq i16 %28, 5
  %30 = zext i1 %29 to i32
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 %30)
  %32 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 2, i32 2
  %33 = load i16* %32, align 2, !tbaa !9
  %34 = icmp eq i16 %33, 32
  %35 = zext i1 %34 to i32
  %36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str6, i64 0, i64 0), i32 %35)
  %37 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 3, i32 2
  %38 = load i16* %37, align 2, !tbaa !9
  %39 = icmp eq i16 %38, 0
  %40 = zext i1 %39 to i32
  %41 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str7, i64 0, i64 0), i32 %40)
  %42 = getelementptr inbounds [5 x %struct.pollfd]* %multi, i64 0, i64 4, i32 2
  %43 = load i16* %42, align 2, !tbaa !9
  %44 = icmp eq i16 %43, 4
  %45 = zext i1 %44 to i32
  %46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str8, i64 0, i64 0), i32 %45)
...
!2 = metadata !{metadata !"_ZTS6pollfd", metadata !3, i64 0, metadata !6, i64 4, metadata !6, i64 6}
