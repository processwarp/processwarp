; ModuleID = 'test_strtoll_hex.bc'
target datalayout = "e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [22 x i8] c"0x4 -0x3A +0xDEADBEEF\00", align 1
@.str1 = private unnamed_addr constant [14 x i8] c"%d%d%d%d%d%d\0A\00", align 1

; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %end_char = alloca i8*, align 8
  %1 = call i64 @strtoll(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8** %end_char, i32 0) #2
  ...
  %6 = call i64 @strtoll(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8** %end_char, i32 16) #2
  %7 = load i8** %end_char, align 8, !tbaa !1
  %8 = call i64 @strtoll(i8* %7, i8** %end_char, i32 16) #2
  %9 = load i8** %end_char, align 8, !tbaa !1
  %10 = tail call i64 @strtoll(i8* nocapture %9, i8** null, i32 16) #2
  %11 = icmp eq i64 %1, 4
  %12 = zext i1 %11 to i32
  %13 = icmp eq i64 %3, -58
  %14 = zext i1 %13 to i32
  %15 = icmp eq i64 %5, 3735928559
