...
@main.str = private unnamed_addr constant [33 x i8] c"memmove can be vvery useful....!\00", align 16
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([33 x i8]* @main.str, i64 0, i64 0), i64 33, i32 16, i1 false)
