...
@main.str = private unnamed_addr constant [32 x i8] c"memmove can be very useful....!\00", align 16

; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %str = alloca [32 x i8], align 16
  %1 = getelementptr inbounds [32 x i8]* %str, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([32 x i8]* @main.str, i64 0, i64 0), i64 32, i32 16, i1 false)
