...
@.str2 = private unnamed_addr constant [33 x i8] c"Compare value strncasecmp is %d\0A\00", align 1
@.str3 = private unnamed_addr constant [28 x i8] c"Compare value memcmp is %d\0A\00", align 1
