...
define void @_Z21stack_manipulate_funcP9jmp_statei(%struct.jmp_state* nocapture %s, i32 %level) #0 {
  ...
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([43 x i8]* @.str, i64 0, i64 0), i32 %level)
...
; <label>:4                                       ; preds = %0
  ...
  %7 = call i32 @_setjmp(%struct.__jmp_buf_tag* %6) #1
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %11

; <label>:9                                       ; preds = %4
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([41 x i8]* @.str1, i64 0, i64 0), i32 0)
  call void @_Z21stack_manipulate_funcP9jmp_statei(%struct.jmp_state* %s, i32 1)
  br label %18

; <label>:11                                      ; preds = %4
  %12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([40 x i8]* @.str2, i64 0, i64 0), i32 0)
  br label %18

; <label>:13                                      ; preds = %0
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([29 x i8]* @.str3, i64 0, i64 0), i32 %level)
  ...
  call void @longjmp(%struct.__jmp_buf_tag* %17, i32 1) #4
  unreachable

; <label>:18                                      ; preds = %11, %9
  %19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([42 x i8]* @.str4, i64 0, i64 0), i32 0)
