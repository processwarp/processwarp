...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  %1 = tail call i8* @catopen(i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i32 0) #3
  %2 = tail call i8* @catgets(i8* %1, i32 0, i32 0, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) #3
  %3 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), i8* %2) #3
