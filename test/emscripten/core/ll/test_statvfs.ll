...
define i32 @main() #0 {
  ...
  %3 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i32 %2) #1
  %4 = tail call i32* @__errno_location() #4
  %5 = load i32* %4, align 4, !tbaa !1
  %6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i32 %5) #1
  %7 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 0
  %8 = load i64* %7, align 8, !tbaa !5
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i64 0, i64 0), i64 %8) #1
  %10 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 1
  %11 = load i64* %10, align 8, !tbaa !8
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0), i64 %11) #1
  %13 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 2
  %14 = load i64* %13, align 8, !tbaa !9
  %15 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str5, i64 0, i64 0), i64 %14) #1
  %16 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 3
  %17 = load i64* %16, align 8, !tbaa !10
  %18 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str6, i64 0, i64 0), i64 %17) #1
  %19 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 4
  %20 = load i64* %19, align 8, !tbaa !11
  %21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str7, i64 0, i64 0), i64 %20) #1
  %22 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 5
  %23 = load i64* %22, align 8, !tbaa !12
  %24 = icmp ugt i64 %23, 5
  %25 = zext i1 %24 to i32
  %26 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str8, i64 0, i64 0), i32 %25) #1
  %27 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 6
  %28 = load i64* %27, align 8, !tbaa !13
  %29 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str9, i64 0, i64 0), i64 %28) #1
  %30 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 7
  %31 = load i64* %30, align 8, !tbaa !14
  %32 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str10, i64 0, i64 0), i64 %31) #1
  %33 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 8
  %34 = load i64* %33, align 8, !tbaa !15
  %35 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str11, i64 0, i64 0), i64 %34) #1
  %36 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 9
  %37 = load i64* %36, align 8, !tbaa !16
  %38 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str12, i64 0, i64 0), i64 %37) #1
  %39 = getelementptr inbounds %struct.statvfs* %s, i64 0, i32 10
  %40 = load i64* %39, align 8, !tbaa !17
  %41 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str13, i64 0, i64 0), i64 %40) #1
...
!6 = metadata !{metadata !"statvfs", metadata !7, i64 0, metadata !7, i64 8, metadata !7, i64 16, metadata !7, i64 24, metadata !7, i64 32, metadata !7, i64 40, metadata !7, i64 48, metadata !7, i64 56, metadata !7, i64 64, metadata !7, i64 72, metadata !7, i64 80, metadata !3, i64 88}
