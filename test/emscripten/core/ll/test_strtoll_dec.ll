...
define i32 @main() #0 {
  ...
  %1 = call i64 @strtoll(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i8** %end_char, i32 0) #2
  ...
  %6 = call i64 @strtoll(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i8** %end_char, i32 10) #2
  %7 = load i8** %end_char, align 8, !tbaa !1
  %8 = call i64 @strtoll(i8* %7, i8** %end_char, i32 10) #2
  %9 = load i8** %end_char, align 8, !tbaa !1
  %10 = tail call i64 @strtoll(i8* nocapture %9, i8** null, i32 10) #2
  %11 = icmp eq i64 %1, 4
