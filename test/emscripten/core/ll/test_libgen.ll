...
@main.p1x = private unnamed_addr constant [16 x i8] c"/usr/lib\00\00\00\00\00\00\00\00", align 16
@.str = private unnamed_addr constant [7 x i8] c"%s -> \00", align 1
@.str1 = private unnamed_addr constant [9 x i8] c"%s : %s\0A\00", align 1
@main.p2x = private unnamed_addr constant [16 x i8] c"/usr\00\00\00\00\00\00\00\00\00\00\00\00", align 16
@main.p3x = private unnamed_addr constant [16 x i8] c"/usr/\00\00\00\00\00\00\00\00\00\00\00", align 16
@main.p4x = private unnamed_addr constant [16 x i8] c"/usr/lib///\00\00\00\00\00", align 16
@main.p5x = private unnamed_addr constant [16 x i8] c"/\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", align 16
@main.p6x = private unnamed_addr constant [16 x i8] c"///\00\00\00\00\00\00\00\00\00\00\00\00\00", align 16
@main.p7x = private unnamed_addr constant [16 x i8] c"/usr/../lib/..\00\00", align 16
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([16 x i8]* @main.p1x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %2 = getelementptr inbounds [16 x i8]* %p1x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([16 x i8]* @main.p1x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* getelementptr inbounds ([16 x i8]* @main.p2x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %8 = getelementptr inbounds [16 x i8]* %p2x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* getelementptr inbounds ([16 x i8]* @main.p2x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %13, i8* getelementptr inbounds ([16 x i8]* @main.p3x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %14 = getelementptr inbounds [16 x i8]* %p3x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* getelementptr inbounds ([16 x i8]* @main.p3x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* getelementptr inbounds ([16 x i8]* @main.p4x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %20 = getelementptr inbounds [16 x i8]* %p4x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %20, i8* getelementptr inbounds ([16 x i8]* @main.p4x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %25, i8* getelementptr inbounds ([16 x i8]* @main.p5x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %26 = getelementptr inbounds [16 x i8]* %p5x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %26, i8* getelementptr inbounds ([16 x i8]* @main.p5x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %31, i8* getelementptr inbounds ([16 x i8]* @main.p6x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %32 = getelementptr inbounds [16 x i8]* %p6x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %32, i8* getelementptr inbounds ([16 x i8]* @main.p6x, i64 0, i64 0), i64 16, i32 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %37, i8* getelementptr inbounds ([16 x i8]* @main.p7x, i64 0, i64 0), i64 16, i32 16, i1 false)
  %38 = getelementptr inbounds [16 x i8]* %p7x, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %38, i8* getelementptr inbounds ([16 x i8]* @main.p7x, i64 0, i64 0), i64 16, i32 16, i1 false)
